...
export const api = {
  ...
  admin: {
    ...
    sendInvitationEmail: (accessToken: string, payload: SendInvitationEmailRequest) => apiRequest<InvitationEmailResponse>('/admin/users/invitations/email', { method: 'POST', body: payload, headers: { Authorization: `Bearer ${accessToken}` } }),
