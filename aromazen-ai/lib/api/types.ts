...
export interface RegulatoryIngredient {
  ...
  classification_source?: string; specific_concentration_limits?: string
  ...
  provenance?: 'excel' | 'official_database' | 'reference_catalog' | 'approved_master' | 'ai_suggested' | 'employee_approved'
}
