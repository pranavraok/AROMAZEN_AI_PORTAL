  ...
  return <main className="space-y-5 p-4 md:p-6">
    ...
    <section className="rounded-2xl border border-primary/25 bg-primary/[.04] p-4 md:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div><h2 className="font-semibold">Custom template library</h2><p className="mt-1 text-xs leading-5 text-muted-foreground">Each master is versioned in the HR Knowledge Base. Export the revised Canva design as DOCX and upload it again to refresh the mapped fields.</p></div>
      ...
      {showCreate && <div className="mt-4 grid gap-3 rounded-xl border border-border bg-card p-4 md:grid-cols-2">
        ...
        <p className="text-xs leading-5 text-muted-foreground md:col-span-2">Use clear placeholders such as {'{{employee_name}}'}, {'{{issue_date}}'} and {'{{designation}}'}. Every unique placeholder becomes one form field.</p>
