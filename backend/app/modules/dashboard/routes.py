    ...
    if is_hr_admin:
        ...
        hr_action_center = HRActionCenter(
            ...
            items=[
                ...
                HRActionItem(key="payroll", title="Automated Slip Generator", description="Prepare, review and email salary or bonus slips.", href="/hr/salary-slips", count=open_payroll_batches, tone="warning" if open_payroll_batches else "default"),
