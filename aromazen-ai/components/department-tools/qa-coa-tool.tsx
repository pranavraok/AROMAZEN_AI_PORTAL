...
export function QaCoaTool() {
  ...
  async function generatePreview() {
    ...
    setBusy(true)
    try {
      const result = await api.documentGenerator.generate(accessToken, { templateId: template.id, documentType: 'coa', fields, rows, fieldLabels, columnLabels })
      setGenerated(result)
