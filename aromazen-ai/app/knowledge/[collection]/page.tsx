...
import { ChevronLeft, ExternalLink, FileText, Lock, Users } from 'lucide-react'
          ...
          {filteredDocs.map((item) => <div key={item.document.id} className="flex items-center gap-3 p-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                {item.collection.name} · {formatSize(item.document.size_bytes)} · v{item.document.version} · {item.document.extracted_characters.toLocaleString()} chars
              </p>
            </div>
